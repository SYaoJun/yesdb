...
set(CRC32C_CONFIGURE    cd ${CRC32C_ROOT}/src/crc32c && cmake -DCMAKE_INSTALL_PREFIX=${CRC32C_ROOT} .)  
set(CRC32C_MAKE         cd ${CRC32C_ROOT}/src/crc32c && make -j 8)  
set(CRC32C_INSTALL      cd ${CRC32C_ROOT}/src/crc32c && make install)  
...
set(CRC32C_INCLUDE_DIRS ${CRC32C_ROOT}/include)